...
\title[Alerts Contents]{LSST Alerts: Science-Driven Options for Packet Contents and Pre-Filtering}
...
A review and discussion of the variety of options for alert packets contents, pre-stream filtering, and so forth.
}
